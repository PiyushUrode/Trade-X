...
const Network = () => {
  ...
  // Dummy data
  const [data, setData] = useState(Networks); // Using dummy data
        ...
        <table className="min-w-full bg-black text-white text-left border-collapse">
          <thead>
            <tr>
              ...
              <th className="border-b p-4  cursor-pointer hover:bg-black" onClick={() => handleSort('rpcUrl')}>
                RPC URL
              </th>
              <th className="border-b p-4 cursor-pointer hover:bg-black" onClick={() => handleSort('exploreUrl')}>
                Explore URL
              </th>
          ...
          <tbody>
            {currentItems.map((item) => (
              <tr key={item.id} className="hover:bg-slate-500">
                ...
                <td className="border-b  p-4">{item.rpcUrl}</td>
                <td className="border-b p-4">{item.exploreUrl}</td>
